...
void PSS( mpz_class n){
    ...
    wlen=seedlen=20;
    string seed="";
    string temp;string w;string expandedW;string seedmask;
    string remainmask;
    string maskedseed;
    string T;
    Integer xw;
    ...
    // cout<<"X:"<<x;
    //cout<<"Tis "<<T<<'\n';
    mpz_class sig = power_1(f, d, n);// cout<<"SIGNED BY PSS:"<<sig;
    FILE *PssF= fopen("PSS.txt", "w");//storing l and sig in a file
    fprintf(PssF, "%d ",l);
